				...
				<div class="row">
					<div class="col-lg-12">
						<ul class="breadcrumb">
							...
							<li class="active"><?= $sjr->judul_halaman ?></li>
						</ul>
					</div>
				</div>
			<?php }?>
		...
		<section id="content">
			<div class="container">
				<div class="row">
					<div class="col-lg-8">
					<?php foreach($sejarah as $sjr) { ?>
						<h3><?= $sjr->judul_halaman?></h3>
						<?php if ($sjr->gambar_halaman != null) { ?>
							<img src="<?=Url::to('@web/upload/halaman/') ?><?= $sjr->gambar_halaman ?>" alt="" class="img-responsive" />
						<?php } else { ?>
						...
						<div class="bottom-article">
							<ul class="meta-post">
								<li><i class="fa fa-user"></i><a href="#"><?= $sjr->nama_user ?></a></li>
								<li><i class="fa fa-eye"></i> &nbsp; <?= $sjr->hit_halaman ?></li>
							</ul>
						</div>
					<?php } ?>
					</div>
